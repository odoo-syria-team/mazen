{
    'name': 'distributor Market Management',
    'summary': '',
    'description': "Allow distributor to request for ability to add his products on the dashboard from website",
    'author': 'Omar Doukmak',
    ...
    'data': [
        ...
        'views/portal/distributors_request_form.xml',
